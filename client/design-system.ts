...
export const DS = {
  ...
  typography: {
    ...
    sizes: {
      ...
      headingLg: 'clamp(1.5rem, 4vw, 2.25rem)',
      headingMd: 'clamp(1.125rem, 3vw, 1.5rem)',
      headingSm: 'clamp(0.875rem, 2.2vw, 1.125rem)',
      body: 'clamp(0.75rem, 1.8vw, 0.938rem)',
      small: 'clamp(0.688rem, 1.5vw, 0.813rem)',
      tiny: 'clamp(0.563rem, 1.2vw, 0.688rem)',
    },
    large: 'clamp(1.75rem, 4.5cqi, 3rem)',
    medium: 'clamp(1.125rem, 2.8cqi, 1.5rem)',
    small: 'clamp(0.75rem, 1.8cqi, 0.88rem)',
    tiny: 'clamp(0.563rem, 1.4cqi, 0.69rem)',
    weightBold: '700',
    weightMedium: '500',
    weightRegular: '400',
    transform: 'uppercase',
  ...
  spacing: {
    none: '0px',
    xs: 'clamp(0.063rem, 0.3cqi, 0.125rem)',
    sm: 'clamp(0.125rem, 0.5cqi, 0.25rem)',
    md: 'clamp(0.25rem, 1cqi, 0.5rem)',
    lg: 'clamp(0.375rem, 1.5cqi, 0.75rem)',
    xl: 'clamp(0.625rem, 2cqi, 1rem)',
    xxl: 'clamp(1rem, 3cqi, 1.5rem)',
    huge: 'clamp(1.25rem, 4cqi, 2rem)'
  },
  layout: {
    headerHeight: 'clamp(2.75rem, 7vh, 3.5rem)',
    colLeft: 'clamp(10rem, 22vw, 15rem)',
    colRight: 'clamp(15rem, 28vw, 22.5rem)',
    sidebarWidth: 'clamp(12.5rem, 25vw, 18.75rem)',
    cardPadding: 'clamp(0.625rem, 2vw, 1.25rem)',
  ...
  shadows: {
    accent: '0 0 1rem rgba(255, 69, 0, 0.15)',
    accentStrong: '0 0 1.5rem rgba(255, 69, 0, 0.3)',
    text: '0.125rem 0.125rem 0.25rem rgba(0,0,0,0.5)',
