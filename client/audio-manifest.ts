...
export const AUDIO_MANIFEST: AudioManifestEntry[] = [
  ...
  { key: 'run_concrete_02', path: 'Audio/Sfx/Locomotion/run_concrete_02.opus', category: 'sfx', loop: false },
  { key: 'run_gravel_01', path: 'Audio/Sfx/Locomotion/run_gravel_01.opus', category: 'sfx', loop: false },
  { key: 'run_gravel_02', path: 'Audio/Sfx/Locomotion/run_gravel_02.opus', category: 'sfx', loop: false },
  { key: 'run_ground_01', path: 'Audio/Sfx/Locomotion/run_ground_01.opus', category: 'sfx', loop: false },
  { key: 'run_ground_02', path: 'Audio/Sfx/Locomotion/run_ground_02.opus', category: 'sfx', loop: false },
  { key: 'run_hard_01', path: 'Audio/Sfx/Locomotion/run_hard_01.opus', category: 'sfx', loop: false },
  { key: 'run_hard_02', path: 'Audio/Sfx/Locomotion/run_hard_02.opus', category: 'sfx', loop: false },
  { key: 'run_metal_01', path: 'Audio/Sfx/Locomotion/run_metal_01.opus', category: 'sfx', loop: false },
  { key: 'run_metal_02', path: 'Audio/Sfx/Locomotion/run_metal_02.opus', category: 'sfx', loop: false },
  { key: 'run_wood_01', path: 'Audio/Sfx/Locomotion/run_wood_01.opus', category: 'sfx', loop: false },
  { key: 'run_wood_02', path: 'Audio/Sfx/Locomotion/run_wood_02.opus', category: 'sfx', loop: false },
  { key: 'walk_gravel_01', path: 'Audio/Sfx/Locomotion/walk_gravel_01.opus', category: 'sfx', loop: false },
  { key: 'walk_gravel_02', path: 'Audio/Sfx/Locomotion/walk_gravel_02.opus', category: 'sfx', loop: false },
  { key: 'walk_ground_01', path: 'Audio/Sfx/Locomotion/walk_ground_01.opus', category: 'sfx', loop: false },
  { key: 'walk_ground_02', path: 'Audio/Sfx/Locomotion/walk_ground_02.opus', category: 'sfx', loop: false },
  { key: 'walk_hard_01', path: 'Audio/Sfx/Locomotion/walk_hard_01.opus', category: 'sfx', loop: false },
  { key: 'walk_hard_02', path: 'Audio/Sfx/Locomotion/walk_hard_02.opus', category: 'sfx', loop: false },
  { key: 'walk_metal_01', path: 'Audio/Sfx/Locomotion/walk_metal_01.opus', category: 'sfx', loop: false },
  { key: 'walk_metal_02', path: 'Audio/Sfx/Locomotion/walk_metal_02.opus', category: 'sfx', loop: false },
  { key: 'walk_wood_01', path: 'Audio/Sfx/Locomotion/walk_wood_01.opus', category: 'sfx', loop: false },
  { key: 'walk_wood_02', path: 'Audio/Sfx/Locomotion/walk_wood_02.opus', category: 'sfx', loop: false },
  { key: 'walk_concrete_01', path: 'Audio/Sfx/Locomotion/walk_concrete_01.opus', category: 'sfx', loop: false },
