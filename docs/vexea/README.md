...
| `VEXEA_UI_DESIGN_SYSTEM.md` | Single CSS-first source for tokens, tagged states, shared keyframes, icon states, settings primitives, quiet ambient categories, and thin vanilla bindings | Authoritative UI design-system contract |
