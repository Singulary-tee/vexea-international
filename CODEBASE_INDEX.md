...
*   **`ui_svgs/`**
    ...
    *   *Glyph replacements:* `class_assault.svg` replaced with the approved double-chevron class glyph; `fullscreen_exit.svg` created as the inward-bracket collapse glyph (180-degree counterpart of `fullscreen.svg`, same 112-grid design family).
---
...
*   **Modifications:**
    ...
    *   `ui_svgs/fullscreen_exit.svg`: Created the exit-fullscreen glyph (inward-pointing L-brackets) used by `client/src/ui/fullscreen.ts` `getFullscreenIconSrc()`.
